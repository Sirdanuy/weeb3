...
let projects = [
  ...
  },
  {
    ...
    url: 'https://secretllamaagency.com/',
  },
  {
    image: 'textures/project-wholesale.jpg',
    url: 'https://tree-henna.vercel.app/',
  },
  {
    image: 'textures/project-pelotero.jpg',
    url: 'https://bitdigitatrading.com/'
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Webberland', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Designer / Blockchain Developer / Game Developer',
      {
        font: font,
        size: 0.018,
        height: 0,
